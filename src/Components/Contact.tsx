            ...
            <div className="container mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-6 sm:p-10  rounded-lg shadow-lg">
                    <form className="space-y-4">
                        ...
                        {/* Submit Button */}
                        <button className="w-full py-3 mt-2 rounded-md text-lg font-semibold bg-gradient-to-r from-purple-500 to-sky-500 shadow-lg hover:shadow-xl transition duration-300">
                            Send Message
                        </button>
                    </form>
                </div>
