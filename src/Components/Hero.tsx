...
// Define lines outside the component to avoid unnecessary re-renders
const lines = [
...
const Hero = () => {
    ...
    }, [index, isDeleting, currentLine]); // ❌ Removed 'lines' from dependencies
        ...
        <section className='hero bg-gradient-to-t from-purple-950 via-black/95 to-black text-white min-h-screen flex flex-col justify-center py-20 px-4 text-center font-[Arial]'>
            <div className='container mx-auto'>
                ...
                <div className='buttons mt-8 flex flex-col sm:flex-row justify-center gap-4'>
                    <button className='relative bg-gradient-to-r from-purple-500 to-sky-500 text-white py-4 px-8 rounded-md text-xl font-bold shadow-lg hover:shadow-purple-500/50 hover:animate-pulse transition-all duration-300'>
                        Deploy Your AI Agent
                    </button>
                    <button className='relative bg-transparent text-white py-3 px-8 border-2 border-purple-500 rounded-md font-bold transition-all duration-300 hover:border-sky-400 hover:shadow-lg hover:animate-pulse'>
                        Watch Demo
                    </button>
                </div>
            </div>
