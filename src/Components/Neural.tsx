...
import { Brain, Bot, Network, ShieldCheck } from 'lucide-react';
        ...
        <section className="bg-black text-white py-16 px-6 text-center relative overflow-hidden">
            <div className="container mx-auto relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mt-10 relative z-10">
                    {/* Card Component */}
                    {[
                        { icon: <Brain />, title: "Autonomous Learning", description: "Self-evolving neural networks that continuously adapt to your business needs through reinforcement learning" },
                        { icon: <Bot />, title: "Multi-Modal Intelligence", description: "Advanced agents capable of processing text, voice, and visual data for comprehensive understanding" },
                        { icon: <Network />, title: "Cognitive Integration", description: "Seamless integration with existing systems through advanced cognitive APIs and neural bridges" },
                        { icon: <ShieldCheck />, title: "Ethical AI Framework", description: "Built-in ethical guidelines and safety protocols ensuring responsible AI deployment" }
                    ].map((item, index) => (
                        <div 
                            key={index} 
