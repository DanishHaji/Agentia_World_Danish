...
import { BrainCircuit, Cpu, BarChart3, Globe } from 'lucide-react';
        ...
        <section className="bg-black text-white py-16 px-4 md:px-16 text-center relative overflow-hidden">
            <div className="container mx-auto relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-10 relative z-10">
                    {/* Card Data */}
                    {[
                        { icon: <BrainCircuit size={28} />, title: "Neural Networks", description: "Advanced neural architectures for complex decision making" },
                        { icon: <Cpu size={28} />, title: "High-Performance CPUs", description: "Optimized for deep learning computations" },
                        { icon: <BarChart3 size={28} />, title: "Advanced ML", description: "Cutting-edge machine learning algorithms" },
                        { icon: <Globe size={28} />, title: "Global Scale", description: "Distributed AI processing across global networks" }
                    ].map((item, index) => (
                        <div 
                            key={index} 
