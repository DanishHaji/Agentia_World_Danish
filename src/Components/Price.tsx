                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-10">
                    {plans.map((plan, index) => (
                        ...
                        >
                            ...
                            {/* Button */}
                            <button className="mt-6 w-full py-2 text-lg font-semibold rounded-lg bg-gradient-to-r from-purple-500 to-sky-500 shadow-lg hover:shadow-xl transition-all duration-300">
                                Get Started
                            </button>
                        </div>
                    ))}
