        ...
        <section className="bg-black text-white py-16 px-6 md:px-16 text-center relative overflow-hidden">
            <div className="container mx-auto relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 relative z-10">
                    {/* Card Data */}
                    {[
                        { icon: <Building2 size={28} />, title: "Enterprise AI", description: "Custom AI agents designed for enterprise-scale operations and decision-making" },
                        { icon: <Network size={28} />, title: "Neural Operations", description: "Automated workflow optimization through distributed neural networks" },
                        { icon: <ShieldCheck size={28} />, title: "Secure Intelligence", description: "Privacy-first AI solutions with military-grade security protocols" }
                    ].map((item, index) => (
                        <div 
                            key={index} 
